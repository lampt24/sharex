...
All 493 keys are available in the default English catalog and all 28 supported culture catalogs. Composite-format placeholders are kept in parity across every translation.
